...
type kxDailiNormalGetter struct {

}


func (g kxDailiNormalGetter) Run(result chan <- *model.Proxy){
	doc, err := utils.Get("http://www.kxdaili.com/dailiip/2/1.html")
	if err != "" {
		return
	}
...
func init(){
	var getter kxDailiNormalGetter
